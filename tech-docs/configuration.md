# Configuration in Boundline 0.69.0
...
The 0.69.0 release keeps planning-readiness evaluation runtime-owned as well:
...
`backlog_mvp_scope`, and `backlog_unmapped_items` are additive runtime output,
