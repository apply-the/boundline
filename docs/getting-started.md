...
Host support modes stay explicit in `0.63.0`: Claude, Codex, and Copilot keep
...
The current Boundline release documents Canon `0.59.0` as the supported CLI target
