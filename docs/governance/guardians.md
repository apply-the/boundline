...
See [Extending the Guidance Catalog](https://github.com/apply-the/boundline/blob/main/tech-docs/guides/extending-guidance-catalog.md) for pack authoring details.
