...
See [Extending the Guidance Catalog](https://github.com/apply-the/boundline/blob/0.72.0/tech-docs/guides/extending-guidance-catalog.md) for pack authoring details.
