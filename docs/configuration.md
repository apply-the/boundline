# Configuration in Boundline 0.52.0

Boundline `0.52.0` keeps a user-friendly setup and routing configuration surface
for the session-native runtime plus explicit compatibility/bootstrap workflows.

The `0.52.0` release keeps configuration behavior stable while preserving the
