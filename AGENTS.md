...
- Non usare MAI `mod.rs`. Usa nomi di file espliciti (es: `directory.rs` allo stesso livello o file singoli).
- Se ci sono enum complessi da mappare, valuta l'uso di `strum` per le macro derivate.
