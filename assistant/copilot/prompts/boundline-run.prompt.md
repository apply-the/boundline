...
**Primary** (always shown): render this clickable link:
[▶ Run /boundline-inspect](command:github.copilot.chat.execute?%5B%22%2Fboundline-inspect%22%5D)

**Secondary** (shown only when delegation is pending or the step is incomplete and re-run is appropriate): render this clickable link:
[▶ Run /boundline-run](command:github.copilot.chat.execute?%5B%22%2Fboundline-run%22%5D)
