...
Host support stays explicit in this release: Codex uses `repo-local-full`, Cursor remains `copy-ready-assets`, and Gemini remains `manual-fallback`. Do not imply richer parity for Cursor or Gemini than the declared support mode.
