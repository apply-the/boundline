...
#[test]
fn release_surface_closes_on_0_49_0_without_an_upcoming_049_entry() {
    ...
    assert!(changelog.contains("## [0.49.0] - 2026-05-11"));
    assert!(changelog.contains("Assistant Plugin Packages"));
    assert!(roadmap.contains("## Current Status: v0.49.0"));
    assert!(roadmap.contains("### Delivered in 0.49.0"));
