...
#[test]
fn release_surface_closes_on_0_46_0_without_an_upcoming_046_entry() {
    ...
    assert!(changelog.contains("## [0.46.0] - 2026-05-09"));
    assert!(changelog.contains("Canon `0.42.0` as the supported Boundline companion"));
    assert!(roadmap.contains("## Current Status: v0.46.0"));
    assert!(roadmap.contains("### Delivered in 0.46.0"));
