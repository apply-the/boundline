...
#[test]
fn release_surface_closes_on_0_42_0_without_an_upcoming_042_entry() {
    ...
    assert!(changelog.contains("## [0.42.0] - 2026-05-06"));
    assert!(changelog.contains("042` - Native Canon CLI Surface"));
    assert!(roadmap.contains("## Current Status: v0.42.0"));
    assert!(roadmap.contains("### Delivered in 0.42.0"));
    ...
    assert!(!roadmap.contains("042-native-canon-cli"));
}
