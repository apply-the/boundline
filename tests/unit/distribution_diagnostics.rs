...
fn render_diagnostics_includes_install_specific_fields() {
    let report = DiagnosticsReport {
        ...
        checks: vec![DiagnosticsCheck {
            ...
            message: "Bundled Canon 0.39.0 is available".to_string(),
        }],
        ready: true,
        missing_prerequisites: Vec::new(),
        suggested_actions: Vec::new(),
        boundline_version: Some("0.39.0".to_string()),
        supported_canon_version: Some("0.39.0".to_string()),
    ...
    assert!(rendered.contains("supported_canon_version: 0.39.0"));
