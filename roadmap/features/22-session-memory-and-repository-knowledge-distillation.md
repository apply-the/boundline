...
| `18-completion-verification-runtime.md` | Produces evidence refs that may support future memory proposals, but proof freshness and closeout gating remain runtime-owned |
