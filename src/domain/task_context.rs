...
pub const LATEST_GOVERNANCE_RUNTIME_STATE_KEY: &str = "latest_governance_runtime_state";
pub const LATEST_GOVERNANCE_ROLLOUT_PROFILE_KEY: &str = "latest_governance_rollout_profile";
pub const LATEST_GOVERNANCE_REASON_KEY: &str = "latest_governance_reason";
pub const LATEST_GOVERNANCE_CONTRACT_LINES_KEY: &str = "latest_governance_contract_lines";
pub const LATEST_GOVERNANCE_APPROVAL_PROVENANCE_KEY: &str = "latest_governance_approval_provenance";
...
pub const TASK_GOAL_KEY: &str = "goal";
pub const TASK_ROUTING_PROJECTION_KEY: &str = "routing_projection";
