...
mod tests {
    ...
    fn parse_canon_capabilities_reads_supported_surface() {
        ...
        assert_eq!(snapshot.canon_version, "0.41.0");
    ...
    fn query_canon_capabilities_reads_cli_output() {
        ...
        let script = write_shell_script(
            ...
            "#!/bin/sh\nprintf '%s' '{\"canon_version\":\"0.41.0\",\"supported_schema_versions\":[\"2026-02-01\"],\"operations\":[\"start\",\"refresh\",\"capabilities\"],\"supported_modes\":[\"verification\"],\"status_values\":[\"governed_ready\"],\"approval_state_values\":[\"not_needed\"],\"packet_readiness_values\":[\"reusable\"],\"compatibility_notes\":[\"stable-json\"]}'\n",
        );
