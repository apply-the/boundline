...
pub use domain::governance::{
    ...
    CanonSemanticProvenanceBoundary, CouncilProfile, GovernanceDegradationMode,
    GovernanceLifecycleState, GovernancePostureResolution, GovernanceProfile,
    GovernanceProfileError, GovernanceRolloutProfile, GovernanceRuntimeKind,
