...
git diff -- README.md tech-docs/getting-started.md tech-docs/configuration.md tech-docs/adaptive-execution.md assistant/README.md CONTRIBUTING.md ROADMAP.md CHANGELOG.md
```
