...
- [X] T001 Bump crate version to `0.28.0` in `/Users/rt/workspace/synod/Cargo.toml` and `/Users/rt/workspace/synod/Cargo.lock`
- [X] T002 Reuse the existing test harness surfaces and extend focused follow-through coverage in `/Users/rt/workspace/synod/tests/unit/cli_output.rs`, `/Users/rt/workspace/synod/tests/unit/compatibility_continuity.rs`, `/Users/rt/workspace/synod/tests/contract/trace_summary_contract.rs`, `/Users/rt/workspace/synod/tests/contract/assistant_command_definition_contract.rs`, and `/Users/rt/workspace/synod/tests/contract/assistant_session_continuity_contract.rs`
...
- [X] T003 Create shared follow-through and continuity-evidence models in `/Users/rt/workspace/synod/src/domain/follow_through.rs`, `/Users/rt/workspace/synod/src/domain.rs`, and `/Users/rt/workspace/synod/src/lib.rs`
- [X] T004 [P] Integrate continuity-evidence precedence helpers for session-native versus compatibility authority in `/Users/rt/workspace/synod/src/domain/follow_through.rs` and `/Users/rt/workspace/synod/src/cli/output.rs`
- [X] T005 [P] Add shared rendering helpers for guided follow-through in `/Users/rt/workspace/synod/src/cli/output.rs`
- [X] T006 [P] Add foundational unit coverage for follow-through projection and compatibility continuity in `/Users/rt/workspace/synod/src/domain/follow_through.rs`, `/Users/rt/workspace/synod/tests/unit/compatibility_continuity.rs`, and `/Users/rt/workspace/synod/tests/unit/cli_output.rs`
...
**Goal**: Let operators see what Synod should do next and why that next step is credible on `status`, `next`, and `inspect`.
...
- [X] T007 [P] [US1] Add focused contract coverage for guided next-action projection on runtime follow-up surfaces in `/Users/rt/workspace/synod/tests/contract/trace_summary_contract.rs`
- [X] T008 [P] [US1] Add focused unit coverage for retry-style and inspect-style follow-through rendering in `/Users/rt/workspace/synod/tests/unit/cli_output.rs`

### Implementation for User Story 1

- [X] T009 [US1] Project guided next-action and evidence headlines into session status rendering in `/Users/rt/workspace/synod/src/domain/follow_through.rs` and `/Users/rt/workspace/synod/src/cli/output.rs`
- [X] T010 [US1] Extend trace summaries and inspect rendering with the same guided follow-through story in `/Users/rt/workspace/synod/src/domain/follow_through.rs` and `/Users/rt/workspace/synod/src/cli/output.rs`
- [X] T011 [US1] Replace generic follow-up wording with bounded guidance or explicit stop conditions in `/Users/rt/workspace/synod/src/domain/follow_through.rs` and `/Users/rt/workspace/synod/tests/unit/cli_output.rs`
...
- [X] T012 [P] [US2] Add coverage for continuity-evidence precedence and compatibility authority boundaries in `/Users/rt/workspace/synod/tests/contract/trace_summary_contract.rs` and `/Users/rt/workspace/synod/tests/unit/compatibility_continuity.rs`
- [X] T013 [P] [US2] Add focused compatibility follow-up continuity coverage in `/Users/rt/workspace/synod/tests/unit/compatibility_continuity.rs` and `/Users/rt/workspace/synod/tests/unit/cli_output.rs`

### Implementation for User Story 2

- [X] T014 [US2] Reuse existing persisted session continuity fields through the shared follow-through projection in `/Users/rt/workspace/synod/src/domain/follow_through.rs` and `/Users/rt/workspace/synod/src/cli/output.rs`
- [X] T015 [US2] Reuse authoritative trace evidence for compatibility follow-up without losing route or continuity ownership in `/Users/rt/workspace/synod/src/domain/follow_through.rs` and `/Users/rt/workspace/synod/src/cli/output.rs`
- [X] T016 [US2] Align compatibility follow-up presentation with explicit evidence precedence and authority boundaries in `/Users/rt/workspace/synod/src/domain/follow_through.rs`, `/Users/rt/workspace/synod/src/cli/output.rs`, and `/Users/rt/workspace/synod/tests/unit/compatibility_continuity.rs`
...
- [X] T017 [P] [US3] Extend assistant-guidance and continuity contract coverage for the new follow-through vocabulary in `/Users/rt/workspace/synod/tests/contract/assistant_session_continuity_contract.rs`, `/Users/rt/workspace/synod/tests/contract/assistant_command_definition_contract.rs`, and `/Users/rt/workspace/synod/tests/contract/assistant_command_pack_contract.rs`
...
- [X] T020 Run focused coverage for modified or created Rust files, refresh `/Users/rt/workspace/synod/lcov.info`, resolve remaining `cargo clippy` issues, run `cargo fmt --all`, and finish with clean validation for touched files under `/Users/rt/workspace/synod/src/` and `/Users/rt/workspace/synod/tests/`
