...
- [x] T030 [P] Update release-facing changelog, roadmap, docs, and wiki pages for the sqlite-vec lifecycle slice in `CHANGELOG.md`, `ROADMAP.md`, `README.md`, `docs/configuration.md`, `docs/getting-started.md`, `docs/architecture.md`, `docs/project-memory-and-evidence-structure.md`, `docs/release-checklist.md`, `../boundline.wiki/Home.md`, `../boundline.wiki/Getting-Started.md`, `../boundline.wiki/Quick-Start.md`, `../boundline.wiki/Troubleshooting.md`, `../boundline.wiki/Architecture-And-Decisions.md`, `../boundline.wiki/Configuration-Reference.md`, `../boundline.wiki/Project-Memory-Structure.md`, and `../boundline.wiki/Traces-And-Inspectability.md`
