# Contextual Help And Documentation Architecture
...
The user needs to know what to do next. Canon and Boundline need the same operational friendliness without losing rigor.
