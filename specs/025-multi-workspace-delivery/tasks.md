...
- [ ] T001 Bump crate version to `0.25.0` in `/Users/rt/workspace/synod/Cargo.toml` and `/Users/rt/workspace/synod/Cargo.lock`
- [ ] T002 Extend clustered workspace fixtures and helper data for multi-repository delivery scenarios in `/Users/rt/workspace/synod/tests/support/workspace_fixture.rs`
- [ ] T003 Register multi-workspace delivery test modules in `/Users/rt/workspace/synod/tests/contract.rs`, `/Users/rt/workspace/synod/tests/integration.rs`, and `/Users/rt/workspace/synod/tests/unit.rs`
...
- [ ] T004 Extend clustered delivery, authority, and workspace-participation models in `/Users/rt/workspace/synod/src/domain/cluster.rs`, `/Users/rt/workspace/synod/src/domain/session.rs`, `/Users/rt/workspace/synod/src/domain/task_context.rs`, and `/Users/rt/workspace/synod/src/domain/trace.rs`
- [ ] T005 [P] Add cluster-aware command inputs and shared resolution helpers for session-native commands in `/Users/rt/workspace/synod/src/cli.rs`, `/Users/rt/workspace/synod/src/cli/session.rs`, and `/Users/rt/workspace/synod/src/cli/run.rs`
- [ ] T006 [P] Align orchestration and persistence helpers for one authoritative clustered delivery story in `/Users/rt/workspace/synod/src/orchestrator/session_runtime.rs`, `/Users/rt/workspace/synod/src/orchestrator/engine.rs`, and `/Users/rt/workspace/synod/src/adapters/cluster_store.rs`
- [ ] T007 [P] Add foundational unit coverage for clustered delivery state, task-context serialization, and command parsing in `/Users/rt/workspace/synod/tests/unit/cluster_models.rs`, `/Users/rt/workspace/synod/tests/unit/task_context_state.rs`, and `/Users/rt/workspace/synod/tests/unit/cli_output.rs`
...
**Independent Test**: Register a valid cluster, run one bounded multi-workspace delivery task, and confirm that Synod records one authoritative delivery story that can read or mutate more than one member workspace without splitting into unrelated runs.

### Tests for User Story 1

- [ ] T008 [P] [US1] Add command and runtime contract coverage for clustered delivery entry and failure boundaries in `/Users/rt/workspace/synod/tests/contract/cluster_cli_contract.rs` and `/Users/rt/workspace/synod/tests/contract/cluster_delivery_contract.rs`
- [ ] T009 [P] [US1] Add integration coverage for a successful bounded clustered delivery journey in `/Users/rt/workspace/synod/tests/integration/cluster_delivery_flow.rs`
- [ ] T010 [P] [US1] Add integration coverage for blocked or non-credible member handoff in `/Users/rt/workspace/synod/tests/integration/cluster_delivery_blocked.rs`

### Implementation for User Story 1

- [ ] T011 [US1] Implement cluster-aware `start`, `capture`, `plan`, and `run` command flow in `/Users/rt/workspace/synod/src/cli.rs`, `/Users/rt/workspace/synod/src/cli/session.rs`, and `/Users/rt/workspace/synod/src/cli/run.rs`
- [ ] T012 [US1] Implement bounded workspace-selection, handoff, and participation recording in `/Users/rt/workspace/synod/src/orchestrator/session_runtime.rs`, `/Users/rt/workspace/synod/src/orchestrator/engine.rs`, and `/Users/rt/workspace/synod/src/domain/task.rs`
- [ ] T013 [US1] Persist clustered delivery authority and workspace participation into session and trace state in `/Users/rt/workspace/synod/src/domain/session.rs`, `/Users/rt/workspace/synod/src/domain/task_context.rs`, and `/Users/rt/workspace/synod/src/domain/trace.rs`
...
- [ ] T014 [P] [US2] Add contract coverage for clustered follow-up authority and participation summaries in `/Users/rt/workspace/synod/tests/contract/runtime_routing_contract.rs`, `/Users/rt/workspace/synod/tests/contract/trace_summary_contract.rs`, and `/Users/rt/workspace/synod/tests/contract/cluster_delivery_contract.rs`
- [ ] T015 [P] [US2] Add integration coverage for clustered `status`, `next`, and `inspect` authority handling in `/Users/rt/workspace/synod/tests/integration/cluster_follow_up_flow.rs` and `/Users/rt/workspace/synod/tests/integration/cli_trace_inspection.rs`
- [ ] T016 [P] [US2] Add unit coverage for clustered summary rendering and inspect-only authority in `/Users/rt/workspace/synod/tests/unit/cli_output.rs`, `/Users/rt/workspace/synod/tests/unit/cluster_projection.rs`, and `/Users/rt/workspace/synod/tests/unit/compatibility_continuity.rs`

### Implementation for User Story 2

- [ ] T017 [US2] Implement clustered follow-up rendering across `/Users/rt/workspace/synod/src/cli/output.rs`, `/Users/rt/workspace/synod/src/cli/inspect.rs`, `/Users/rt/workspace/synod/src/cli/cluster.rs`, and `/Users/rt/workspace/synod/src/cli/session.rs`
- [ ] T018 [US2] Extend session and trace projection builders with authoritative workspace and workspace-participation cues in `/Users/rt/workspace/synod/src/domain/session.rs`, `/Users/rt/workspace/synod/src/domain/trace.rs`, and `/Users/rt/workspace/synod/src/cli/inspect.rs`
...
- [ ] T019 [P] [US3] Add assistant and documentation coverage for clustered delivery guidance in `/Users/rt/workspace/synod/tests/contract/assistant_session_continuity_contract.rs` and `/Users/rt/workspace/synod/tests/unit/cli_output.rs`
...
- [ ] T021 [US3] Refresh generated agent context for clustered delivery surfaces in `/Users/rt/workspace/synod/AGENTS.md`
